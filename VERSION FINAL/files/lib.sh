...
NEW
				...
				if [ $? -eq 0 ]
					...
					mensaje 4
					textoLog="Contraseña: Se ha creado una nueva contraseña."
					escribirLog
					menuGestionContra
...
TEMPMOD
			...
			if [ $? -eq 0 ]
				...
				mensaje 8
				textoLog "Contraseña: Se ha modificado la contraseña."
				escribirLog
				menuGestionContra
...
function eliminaContra(){
	...
	if [ $? -eq 0 ]
		...
		mensaje 6
		textoLog "Contraseña: Se ha eliminado la contraseña."
		escribirLog
		menuGestionContra
	else
		mensaje 15
